window.BIRL_PROJECTS = [
  ...
  ['ei-conference','2023','systems','Community','コミュニティ','EI Conference','EI Conference','An international forum for embodied intelligence research.','身体知能研究のための国際フォーラム。'],
  ...
  ['body-dynamics-sensing','Legacy','sensing','Sensing','センシング','Sensing through body dynamics','身体ダイナミクスによる知覚','How perception, control, and physical dynamics shape one another.','知覚、制御、身体の動きが形づくる相互関係。'],
  ...
  ['non-verbal-face-robot','Legacy','systems','Interaction','インタラクション','Active non-verbal face robot','非言語対話フェイスロボット','Artificial muscles and expression for human–robot communication.','人工筋肉と表情による人とロボットのコミュニケーション。']
];
